...
const isolatedRoot = mkdtempSync(join(tmpdir(), "reading-world-taxonomy-e2e-"));
process.env.READING_WORLD_TAXONOMY_E2E_TEMP_ROOT = isolatedRoot;

export default defineConfig({
  testDir: "./e2e",
  testMatch: "public-library-taxonomy.spec.ts",
  globalTeardown: "./e2e/public-library-taxonomy.teardown.ts",
  fullyParallel: false,
  retries: 0,
  workers: 1,
  reporter: "line",
