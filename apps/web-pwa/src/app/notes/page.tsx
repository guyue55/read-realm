      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col gap-6 mt-4">
        {loading ? (
          <div className="flex items-center justify-center p-20">
            <div className="animate-spin text-[#678055] text-4xl font-light">
              ↻
            </div>
          </div>
        ) : bookmarks.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {bookmarks.map((bookmark) => (
              <div
                key={bookmark.id}
                className="bg-[#FFFDF8] p-6 rounded-[20px] shadow-[0_4px_16px_rgba(80,65,45,0.06)] border border-[rgba(80,65,45,0.08)] flex flex-col hover:shadow-[0_8px_24px_rgba(80,65,45,0.12)] transition-shadow"
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="flex flex-col">
                    <span className="text-sm font-bold text-[#2F2A24] font-serif">
                      {bookmark.bookTitle}
                    </span>
                    <span className="text-xs text-[#6F665B] mt-1">
                ...
                <div className="flex-1 bg-[#F4ECD8] p-4 rounded-[12px] border border-[#E4D9C9] relative mb-6">
                  <div className="absolute top-4 left-4 text-4xl text-[#DED6C8] font-serif leading-none opacity-50 select-none pointer-events-none">
                    &quot;
                  </div>
