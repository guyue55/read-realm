...
- 活体验收：REV-0002 以固定 EPUB 完成导入到阅读进度落盘、刷新与真断网恢复；隔离真实 v9→v10 迁移故障自动回滚并能打开旧数据。浏览器强制关闭的绝对完成保证仍不作承诺。
...
- 下一入口：PHASE-03 / TASK-0301；冻结导入任务状态机与容量 fixtures，扩展导入和可携带性但不改写 PHASE-02 风险门历史。
